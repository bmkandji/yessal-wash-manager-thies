    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <StatsCard 
            title="Revenus"
            value={todaysStats.revenue}
            icon={<CreditCard className="h-8 w-8 text-primary" />}
          />
          <StatsCard 
            title="Poids traité"
            value={todaysStats.weight}
            icon={<Scale className="h-8 w-8 text-primary" />}
          />
          <StatsCard 
            title="Livraisons"
            value={todaysStats.deliveries.toString()}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <StatsCard 
            title="Commandes"
            value={weeklyStats.orders.toString()}
            icon={<Package className="h-8 w-8 text-primary" />}
          />
          <StatsCard 
            title="Revenus"
          ...
          <StatsCard 
            title="Poids traité"
            value={weeklyStats.weight}
            icon={<Scale className="h-8 w-8 text-primary" />}
          />
          <StatsCard 
            title="Livraisons"
            value={weeklyStats.deliveries.toString()}
            icon={<Truck className="h-8 w-8 text-primary" />}
          />
        </div>
      </div>
