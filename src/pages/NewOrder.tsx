      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {clientType === 'registered' ? 'Créer une commande pour le client sélectionné' : 'Créer une commande sans compte client'}
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="overflow-hidden border-l-4 border-l-primary">
          <CardContent className="p-4">
            ...
            {clientType === 'registered' && client ? <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <RadioGroup value={formData.formulaType} onValueChange={value => handleFormulaChange(value as 'basic' | 'subscription' | 'weight')} className="space-y-2">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="flex items-center space-x-2">
                <Input type="number" min="0" step="0.1" value={formData.weight || ''} onChange={handleWeightChange} className="text-lg font-medium" />
          ...
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-center space-x-2 border rounded-md p-3 hover:bg-gray-50">
                <Checkbox id="option-ironing" checked={formData.options.ironing} onCheckedChange={() => handleOptionChange('ironing')} />
              ...
              <div className="flex items-center space-x-2 border rounded-md p-3 hover:bg-gray-50">
                <Checkbox id="option-stain" checked={formData.options.stainRemoval} onCheckedChange={() => handleOptionChange('stainRemoval')} />
                <div className="flex-grow">
                  <Label htmlFor="option-stain" className="cursor-pointer">Séchage</Label>
                  <p className="text-xs text-gray-500">+500 FCFA</p>
                </div>
              </div>
              <div className="flex items-center space-x-2 border rounded-md p-3 hover:bg-gray-50">
                <Checkbox id="option-urgent" checked={formData.options.urgent} onCheckedChange={() => handleOptionChange('urgent')} />
                <div className="flex-grow">
                  <Label htmlFor="option-urgent" className="cursor-pointer">Express</Label>
                  <p className="text-xs text-gray-500">+15% du total</p>
                </div>
              </div>
              <div className="flex items-center space-x-2 border rounded-md p-3 hover:bg-gray-50">
                <Checkbox id="option-delivery" checked={formData.options.delivery} onCheckedChange={() => handleOptionChange('delivery')} />
                <div className="flex-grow">
